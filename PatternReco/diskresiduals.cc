...
public:
  ...
  void Draw(TCanvas* c){
    ...
    hist116l_->GetXaxis()->SetNdivisions(12);
    ...
    hist116m_->GetXaxis()->SetNdivisions(12);
    ...
    hist116h_->GetXaxis()->SetNdivisions(12);
    ...
    hist116_->GetXaxis()->SetNdivisions(12);
